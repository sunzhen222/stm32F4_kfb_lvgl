...
/**
* added by leon.sun,when ready,call ready_cb
* 
* 
*/
void lv_page_scroll_ver_with_cb(lv_obj_t * page, lv_coord_t dist, void (*ready_cb)(void))
{
    lv_obj_t * scrl = lv_page_get_scrl(page);
    ...
    a.exec_cb = (lv_anim_exec_xcb_t)lv_obj_set_y;
    a.path_cb = lv_anim_path_linear;
    a.ready_cb = (lv_anim_ready_cb_t)ready_cb;
    a.act_time = 0;
    a.time = LV_PAGE_SCROLL_ANIM_TIME;
    a.playback = 0;
    a.playback_pause = 0;
